...
// -----Search/Query AJAX-----
function query(term, dest=curSection, search=true){
        ...
        if (Object.keys(response)[0] == 'data'){
          if (search){
            ...
            $('.results-button').click(function(){
              // Query with symbol, destination, and search=false
              query($(this).closest('tr').find('td:eq(1)').text(), $(this).attr('data-dest'), false);
            });
